cask "samsung-magician" do
  ...
  pkg "Samsung_Magician_installer_Official_#{version}_unattend.pkg"
  ...
  preflight do
    ...
    system("sed -i -e '/osascript -e \"display alert \\\\\"\\$pssdUninstallAlert\\\\\"/ s/^/#/g' #{staged_path}/Package_Content/SamsungMagicianSVC.pkg/Scripts/preinstall")
    system "pkgutil", "--flatten", "#{staged_path}/Package_Content", "#{staged_path}/Samsung_Magician_installer_Official_#{version}_unattend.pkg"
  end
